...
<template>
  <div>
    <EmployeeDetailCard :employee="employee" :skeleton-loading="loading" />

    <div class="mt-6">
      <!-- My Profile -->
      <Card
        v-ripple
        class="shadow cursor-pointer hover:bg-gray-50 transition mt-4"
      ...
      <!-- Change Password -->
      <Card v-ripple class="shadow cursor-pointer hover:bg-gray-50 transition mt-4" @click="navigateTo('/settings/security')">
        <template #content>
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
              ...
              <span class="text-gray-800 font-medium">Account Security</span>
            </div>
            <i class="pi pi-angle-right text-gray-400" />
          </div>
        </template>
