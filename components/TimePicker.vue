...
<template>
    ...
    >
        ...
        />
        <!-- center knob -->
        <div class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-3 h-3 bg-violet-600 rounded-full pointer-events-none"></div>
        <!-- tip knob -->
        <div class="absolute w-6 h-6 bg-violet-600 rounded-full shadow pointer-events-none" :style="tipStyle"></div>
