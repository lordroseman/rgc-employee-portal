...
const { employeeLeaves, leaveBalance } = storeToRefs(employeeLeaveStore);
...
const refresh = async () => {
  ...
  await Promise.all([
    employeeLeaveStore.getLeaveByEmployee(true),
    employeeLeaveStore.getLeaveBalance(),
  ]);
...
onMounted(async () => {
  skeletonLoading.value = true;
  await Promise.all([
    employeeLeaveStore.getLeaveByEmployee(),
    employeeLeaveStore.getLeaveBalance(),
  ]);
  skeletonLoading.value = false;
});
...
<template>
  <PullToRefresh @refresh="refresh">
    ...
    <div class="grid grid-cols-2 gap-3 mb-6 mt-4 z-10 relative">
          ...
          <div class="py-0 text-center">
            ...
            <div class="flex items-center gap-3">
              ...
              <div class="text-xl font-bold">
                <div v-if="skeletonLoading"><Skeleton width="5rem" class="mb-2" /></div>
                <div v-else>{{ leaveBalance?.sil_balance.remaining_days }}</div>
              </div>
            </div>
          </div>
        </template>
          ...
          <div class="py-0 text-center">
            ...
            <div class="flex items-center gap-3">
              <div class="rounded-full bg-amber-50 px-2 pt-2 pb-1">
                <i class="pi pi-hourglass text-amber-600" style="font-size: 18px" />
              </div>
              <div class="text-xl font-bold">
                <div v-if="skeletonLoading"><Skeleton width="5rem" class="mb-2" /></div>
          ...
          <div class="py-0 text-center">
            ...
            <div class="flex items-center gap-3">
              <div class="rounded-full bg-green-50 px-2 pt-2 pb-1">
                <i class="pi pi-check-circle text-green-600" style="font-size: 18px" />
              </div>
              <div class="text-xl font-bold">
                <div v-if="skeletonLoading"><Skeleton width="5rem" class="mb-2" /></div>
          ...
          <div class="py-0 text-center">
            ...
            <div class="flex items-center gap-3">
              <div class="rounded-full bg-red-50 px-2 pt-2 pb-1">
                <i class="pi pi-times-circle text-red-600" style="font-size: 18px" />
              </div>
              <div class="text-xl font-bold">
                <div v-if="skeletonLoading"><Skeleton width="5rem" class="mb-2" /></div>
    ...
    <div class="mt-4">
      ...
      <Tabs value="0" class="w-full">
        ...
        >
          <Tab
            value="0"
            class="w-1/3 text-center px-4 py-2 text-sm font-medium transition"
          >
            Pending
          </Tab>
          <Tab
        ...
        <TabPanels class="!p-0">
          <TabPanel value="0">
                ...
                <div class="flex items-start justify-between gap-6 basis-1/2">
                  ...
                  <div class="flex items-start gap-3">
                    <div>
                      ...
                      <div
                        class="mt-4 text-[10px] font-medium uppercase tracking-wide text-gray-500"
                      >
                        Date To
                      </div>
                      <div class="text-sm font-bold text-gray-900 uppercase">
            ...
            <div v-else>
                    ...
                    <div class="flex items-start justify-between gap-6 basis-1/2">
                      ...
                      <div class="flex items-start gap-3">
                        <div>
                          ...
                          <div class="text-sm font-bold text-gray-900 uppercase">
                            {{ useDateFormat(leave.date_from as string, "MMM DD, YYYY") }}
                          </div>
                          ...
                          <div class="text-sm font-bold text-gray-900 uppercase">
                            {{ useDateFormat(leave.date_to as string, "MMM DD, YYYY") }}
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="grid grid-cols-2 gap-x-8 gap-y-3 basis-1/2">
                        <div>
                          ...
                          <div class="text-sm font-bold text-gray-900">
                            {{ calcDuration(leave.date_from as string, leave.date_to as string) }}
                            <span class="font-medium text-gray-500">days</span>
                          </div>
                        </div>
              ...
              <div v-else class="p-4 text-center">No data to display.</div>
            </div>
          </TabPanel>
          <TabPanel value="1">
