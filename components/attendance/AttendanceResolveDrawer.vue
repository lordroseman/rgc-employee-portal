...
<template>
  ...
  >
    ...
    <div class="px-4 py-2">
              ...
              >
                  <template #item="{ element, index }">
                      <div class="mb-3 border border-gray-400 rounded-md bg-white cursor-grab touch-pan-y select-none">
                          <InputText class="w-full" v-model="element.time" @click="openPicker(index)" readonly="true" />
                      </div>
                  </template>
              </Draggable>
      ...
      <div>
        <TimePicker v-model="time" v-model:visible="showPicker" @update:modelValue="applyInputTime" />
      </div>
    </div>
