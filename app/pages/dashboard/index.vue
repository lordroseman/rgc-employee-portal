...
const todaysAttendance = computed<Record<string, Attendance> | null>(
  () => employeeAttendance.value
);
const todaysSchedule = computed<Record<string, Schedule> | null>(
          ...
          <div class="cursor-pointer">
            ...
            >
              <i
                :class="[
                  'pi',
                  showSalary ? 'pi-eye' : 'pi-eye-slash',
    ...
    <Card v-if="false" class="mb-6 no-padding-card">
      ...
      <template #content>
        <div class="flex items-start justify-between p-4">
          ...
          <div class="text-[#4D4D4D] text-sm">Thursday</div>
        </div>
        ...
        <div class="flex items-start justify-between p-4">
          ...
          <div class="text-[#4D4D4D] text-sm">Friday</div>
        </div>
        ...
        <div class="flex items-start justify-between p-4">
          <div class="flex flex-col items-start gap-1">
            ...
            <Tag
              class="!bg-indigo-50 !text-indigo-500"
              value="Overtime"
              style="font-size: 10px"
            />
          </div>
          <div class="text-[#4D4D4D] text-sm">Saturday</div>
        </div>
        ...
        <div class="flex items-start justify-between p-4">
          ...
          <div class="text-[#4D4D4D] text-sm">Monday</div>
        </div>
